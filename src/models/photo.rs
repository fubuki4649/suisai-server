...
///
/// # Fields
/// - `id` (`String`): UUIDv7. Serialized as "photoId" in JSON
...
#[derive(DerivePartialModel, Queryable, Selectable, AsChangeset, Serialize, Debug)]
#[sea_orm(entity = "crate::db::entities::photos::Entity")]
...
/// - `shutter_speed` (`String`): Exposure time as a string (e.g. "1/250")
/// - `aperture` (`f32`): F-stop value used
#[derive(DerivePartialModel, Insertable, Deserialize, Serialize, Debug)]
#[sea_orm(entity = "crate::db::entities::photos::Entity")]
#[serde(rename_all = "camelCase")]
#[diesel(table_name = photos)]
pub struct NewPhoto {
